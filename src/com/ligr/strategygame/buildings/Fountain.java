...
public class Fountain extends SpriteObject {
	...
	public Fountain(float pX, float pY, ITextureRegion pTextureRegion,
		...
		if (!load)
			main.getController().updateWorkers(ConstantBuildings.WORKERSFOUNTAIN, 0);
		yBaseStart = 27;
	}
	...
	public boolean onAreaTouched(TouchEvent pSceneTouchEvent,
		...
		if (pSceneTouchEvent.isActionUp()) {
			...
			if (main.boolplacebuilding == false && pressedDown
				...
				pressedDown = false;
				main.addBuildingDescription("Fountain", "The fountain provides nearby houses with a steady supply of water");

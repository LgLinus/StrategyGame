...
public class HUDMoreInfoWorkers extends Sprite {


	public HUDMoreInfoWorkers(float pX, float pY, ITextureRegion pTextureRegion,
    ...
    public boolean onAreaTouched(TouchEvent pSceneTouchEvent, float pTouchAreaLocalX, float pTouchAreaLocalY) {
		...
		if(pSceneTouchEvent.isActionUp()){
			MainActivity.MoreInfoText.setText(MainActivity.WorkersDescriptionString);
